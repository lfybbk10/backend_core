...
class DealProductIntegrationTest {
  ...
  void testSaveDealWithProducts() {
    ...
    assertThat(dealFromRepository.getDealProducts().get(0).getUnitPrice())
        .isEqualTo(new BigDecimal(81000));

    assertThat(dealFromRepository.getDealProducts().get(1).getQuantity()).isEqualTo(1);
    assertThat(dealFromRepository.getDealProducts().get(1).getUnitPrice())
        .isEqualTo(new BigDecimal(25000));
  }
