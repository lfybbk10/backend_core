...
public class Application {
    ...
    @Bean
    @Profile("dev")
    CommandLineRunner seedLeads(DealJpaRepository dealRepository, ProductJpaRepository productRepository) {
        return args -> {
            //repository.save(new Lead(null,"test1@mail.com", new Company("comp1"), "NEW"));
